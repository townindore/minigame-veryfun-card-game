...
public class DeckOfCards extends JFrame {
	...
	public DeckOfCards() {
		...
		final JButton skipButton = new JButton("Skip(Once)");
		...
		skipButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			//Action performed once skip is clicked
			skipButton.setEnabled(false);
			maximum = 10;
			currentCard++;
			status.setText(deck[currentCard].toString()); //Change Status to Card Name
		...
		gridButton[i].addActionListener(new ActionListener() {
				...
				//The following is progess of the last grid button clicked
				if (currentCard == maximum )
				{
